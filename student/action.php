...
if(isset($_POST['add_feedback']))
{
    ...
    $query_run1 = mysqli_query($con, $query0);
        ...
        $query = "INSERT INTO `feedback`(`s_prn`, `f_empid1`, `f_subject`, `q1`, `q2`, `q3`, `q4`, `q5`, `f_year`,`q6`,`q7`,`f_branch` ) VALUES ('$s_prn','$f_empid1','$f_subject','$q1','$q2','$q3','$q4','$q5','$f_year','$q6','$q7','$f_branch')";
